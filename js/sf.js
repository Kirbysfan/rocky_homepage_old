(function () {
   ...
   */
  function setup() {
    var number = navigator.appVersion.search(/\bx64\b/i) > 0 ? 256 : 64,
      particle,
      i;
...
var deadline = new Date("Jan 22, 2023 00:00:00").getTime();
function nycountdown() {
  ...
  if (lang === "en") {
    document.getElementById("Countdown").innerHTML = days + "d "
      + hours + "h " + minutes + "m " + seconds + "s Until Chinese new year!";
    if (t < 0) {
      clearInterval(x);
    ...
    document.getElementById("Countdown").innerHTML = "距离春节还有" + days + "天"
    ...
    document.getElementById("Countdown").innerHTML = "距離春節還有" + days + "天 "
